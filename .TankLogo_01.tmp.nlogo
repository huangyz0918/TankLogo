...
to tank-prepare-red
  ...
  let tks other Tanks with [distance myself < TankSize + 2]
  ifelse count tks > 0 [status-stop-turn][status-forward]

  ask patches with [distance myself <  and pcolor = yellow][
    ask myself[
      status-stop-turn
    ]
